...
export default function ProductCard({
  ...
  return (
    <div className='w-80 rounded-custom border border-neutral-300 p-4 shadow-sm transition-transform duration-150 ease-out hover:scale-[1.05]'>
      <img
      ...
      <div className='flex items-center justify-between py-4'>
        <h2 className='w-[75%] text-orange-400'>{title}</h2>
